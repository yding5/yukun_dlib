...
def get_files_in_folder(path):
  ...
  for name in pkg_resources.resource_listdir("yukun_disentanglement_lib", path):
    new_path = path + "/" + name
    if not pkg_resources.resource_isdir("yukun_disentanglement_lib", new_path):
      yield pkg_resources.resource_filename("yukun_disentanglement_lib", new_path)
